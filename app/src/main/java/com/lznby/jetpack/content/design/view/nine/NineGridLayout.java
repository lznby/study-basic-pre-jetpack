...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private List<FilePathEntity> mUrlList = new ArrayList<>();
    ...
    public void setUrlList(List<FilePathEntity> urlList) {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            FilePathEntity url = mUrlList.get(0);
        ...
        for (int i = 0; i < size; i++) {
            FilePathEntity url = mUrlList.get(i);
    ...
    private RatioImageView createImageView(final int i, final FilePathEntity url) {
     ...
     */
    private void layoutImageView(RatioImageView imageView, int i, FilePathEntity url, boolean showNumFlag) {
    ...
    private int getListSize(List<FilePathEntity> list) {
     ...
     */
    protected abstract boolean displayOneImage(RatioImageView imageView, FilePathEntity url, int parentWidth);

    protected abstract void displayImage(RatioImageView imageView, FilePathEntity url);

    protected abstract void onClickImage(int position, FilePathEntity url, List<FilePathEntity> urlList);
}
